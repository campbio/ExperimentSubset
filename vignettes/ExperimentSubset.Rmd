...
The `storeSubset` method should be used when a subset `assay` needs to be stored
...
altExp(x = es,
       e = "subset2_alt1",
       subsetName = "subset2") <- es@subsets$subset2@internalAssay
```
